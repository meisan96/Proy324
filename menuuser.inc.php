            ...
            <div class="navbar-brand">
                <span class="navbar-logo">
                    <a href="https://mobiri.se">
                        <img src="/fcpn/assets/images/fcpn-blue-96x96.png" alt="Mobirise" style="height: 3rem;">
                    </a>
                </span>
...
<?php 
if($_SESSION['rol']==1){
    echo '/bpmver/usuario/notas/';
}else{
    echo '/bpmver/usuario/notas/controlflujodoc.php?flujo_seleccionado=F2';
}
?>
                        " aria-expanded="true"><span class="mobi-mbri mobi-mbri-users mbr-iconfont mbr-iconfont-btn"></span><?php 
                        if($_SESSION['rol']==1){
                            echo "Inscribir";
                        }
                        else{
                ...
                <div class="navbar-buttons mbr-section-btn"><a class="btn btn-primary display-4" href="/bpmver/config/cerrar.php"><span class="mobi-mbri mobi-mbri-paper-plane mbr-iconfont mbr-iconfont-btn"></span>Cerrar Sesion</a></div>
            </div>
        </div>
    </nav>
</section>
